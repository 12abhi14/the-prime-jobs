    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience', models.CharField(choices=[('No Experience', 'No Experience'), ('1 Year', 'One Year'), ('2 Years', 'Two Years'), ('3 Years above', 'Three Years')], default='No Experience', max_length=20)),
